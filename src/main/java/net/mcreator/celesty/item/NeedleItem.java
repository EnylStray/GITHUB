...
import net.mcreator.celesty.procedures.NeedleEvenementAuClicDroitDansLairProcedure;
import net.mcreator.celesty.item.inventory.NeedleInventoryCapability;
...
public class NeedleItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Needle");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new NeedleGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
		...
		NeedleEvenementAuClicDroitDansLairProcedure.execute(entity, itemstack);
		return ar;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new NeedleInventoryCapability();
	}
